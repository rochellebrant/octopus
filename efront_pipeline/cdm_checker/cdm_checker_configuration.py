...
DATA_CATALOG = get_bundle_param("DATA_CATALOG", "xio.data_catalog", "oegen_data_prod_test")
LANDING_SCHEMA = get_bundle_param("LANDING_SCHEMA", "xio.landing_schema", "efront_landing")
