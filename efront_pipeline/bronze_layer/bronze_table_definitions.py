column_definitions = {
    ...
    "fees_company": {
        "table": {
            "comment": "Data table containing itemized records of fees, costs, and expenses associated with specific entities or companies."
        },
        "columns": {
            "Comment": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "A description or specific detail regarding the nature of the fee",
            ...
            "Created_on": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "Timestamp indicating when the fee record was originally created in the source system",
                    "long_name": "Source Record Creation Timestamp",
                    "unit": "n/a"
                }
            },
            "Draft": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Flag indicating if the fee record is in a draft or uncommitted state (e.g., True/False)",
            ...
            "Effective_date": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "The date on which the fee or cost becomes effective or is applied",
            ...
            "Entity": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The legal name of the entity, company, or SPV associated with the fee",
                    "long_name": "Entity Name",
                    "unit": "n/a"
                }
            },
            "IQId": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The unique system identifier (GUID) for the fee record from the source API",
            ...
            "Modified_by": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The username or system ID that last modified the fee record",
                    "long_name": "Last Modified By",
                    "unit": "n/a"
                }
            },
            "Modified_on": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "Timestamp indicating the last modification of the fee record in the source system",
                    "long_name": "Source Record Modification Timestamp",
                    "unit": "n/a"
                }
            },
            "Net_Amount_Due": {
                "schema": {"data_type": "DOUBLE"},
                "description": {
                    "comment": "The total net financial amount due for the fee or cost",
            ...
            "Type": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The classification or category of the fee (e.g., Transaction Fee, W&I cost)",
                    "long_name": "Fee Type",
                    "unit": "n/a"
                }
            },
            "Prepayment": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Flag indicating whether the fee was paid in advance as a prepayment",
            ...
            "Release": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Flag indicating whether the fee record is associated with a release of funds or liabilities",
    ...
    "fees_fund": {
        "table": {
            "comment": "Data table containing itemized records of fees and allocations at the fund and investor level."
        },
        "columns": {
            "Allocation_Rule": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The specific rule or period description determining how the fee is allocated (e.g., OEDP Mgmt Fee Jun-22)",
            ...
            "Created_on": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "Timestamp indicating when the fund fee record was originally created in the source system",
                    "long_name": "Source Record Creation Timestamp",
                    "unit": "n/a"
                }
            },
            "Effective_date": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "The date on which the fund fee or allocation becomes effective",
                    "long_name": "Effective Date",
                    "unit": "n/a"
                }
            },
            "Fund": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The legal name of the fund associated with the fee",
                    "long_name": "Fund Name",
                    "unit": "n/a"
                }
            },
            "Gross_Amount_Due": {
                "schema": {"data_type": "DOUBLE"},
                "description": {
                    "comment": "The gross financial amount due for the fee prior to any deductions",
            ...
            "IQId": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The unique system identifier (GUID) for the fund fee record from the source API",
                    "long_name": "Fee Record GUID",
                    "unit": "n/a"
                }
            },
            "Investor": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The name or short code of the investor to whom the fee portion is allocated",
            ...
            "Modified_by": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The username or system ID that last modified the fund fee record",
                    "long_name": "Last Modified By",
                    "unit": "n/a"
                }
            },
            "Modified_on": {
                "schema": {"data_type": "TIMESTAMP"},
                "description": {
                    "comment": "Timestamp indicating the last modification of the fund fee record in the source system",
                    "long_name": "Source Record Modification Timestamp",
                    "unit": "n/a"
                }
            },
            "Short_Name": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The short name or ticker used internally to identify the fund",
                    "long_name": "Fund Short Name",
                    "unit": "n/a"
                }
            },
            "Type": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "The classification or category of the fee (e.g., Management Fee)",
                    "long_name": "Fee Type",
                    "unit": "n/a"
                }
            },
            "Units": {
                "schema": {"data_type": "DOUBLE"},
                "description": {
                    "comment": "The apportioned units or exact amount allocated to the specific investor",
            ...
            "Net_Amount_Due": {
                "schema": {"data_type": "DOUBLE"},
                "description": {
                    "comment": "The total net financial amount due for the fund fee after relevant deductions",
                    "long_name": "Net Amount Due",
                    "unit": "fund currency"
                }
            },
    ...
    "investoraccount": {
        ...
        "columns": {
            ...
            "Grouping_Code": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Grouping code of whether the investor account is hedged or unhedged.",
                    "long_name": "Hedged Grouping Code",
                    "unit": "n/a"
                }
            },
            "datalake_ingestion_timestamp": {
    ...
    "instruments": {
        ...
        "columns": {
            ...
            "OEGEN_type": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Categorises the structural level of external debt facilities associated with this instrument, differentiating between debt raised for a specific underlying project versus debt raised at the overarching fund level.",
    ...
    "investor": {
        ...
        "columns": {
            "Country": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Country where the investor is registered or domiciled",
                    "long_name": "Investor Country",
                    "unit": "n/a"
                }
            },
            ...
            "Currency": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Currency used by the investor for financial reporting",
            ...
            "Investor_Type": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Classification of the investor (e.g., individual, institutional)",
                    "long_name": "Investor Type",
                    "unit": "n/a"
                }
            },
    ...
    "transactions": {
        ...
        "columns": {
            ...
            "OEGEN_type": {
                "schema": {"data_type": "STRING"},
                "description": {
                    "comment": "Categorises the structural level of external debt facilities within the investment portfolio, differentiating between debt raised for a specific underlying project versus debt raised at the overarching fund level.",
                    "long_name": "OEGEN Type",
                    "unit": "n/a"
                }
            },
