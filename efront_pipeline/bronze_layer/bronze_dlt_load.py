...
from bronze_table_definitions import column_definitions as COLUMN_DEFINITIONS
...
PARAM_MODULE_NAME = spark.conf.get("xio.table_parameters_module", "bronze_table_parameters")
