gold_kpis_by_reporting_technology_sql_code = """
WITH StrategyTotals AS (
  SELECT
    Report_Date,
    Reporting_Asset_Technology AS Technology,
    SUM(AUM) AS AUM,
  ...
  GROUP BY Report_Date, Reporting_Asset_Technology
),
ReportTotals AS (
  SELECT
    Report_Date,
...
ORDER BY s.Report_Date DESC, s.Technology
"""