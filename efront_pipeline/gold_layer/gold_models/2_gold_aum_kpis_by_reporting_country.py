gold_aum_kpis_by_reporting_country_sql_code = """
WITH StrategyTotals AS (
  SELECT
    Report_Date,
    Reporting_Asset_Country AS Country,
    SUM(AUM) AS AUM,
  ...
  GROUP BY Report_Date, Reporting_Asset_Country
),
ReportTotals AS (
  SELECT
    Report_Date,
...
ORDER BY s.Report_Date DESC, s.Country
"""