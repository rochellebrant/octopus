...
gold_fundoperations_investor_type_share_monthly_sql_code = '''
WITH detail AS (
  SELECT
    Fund,
    Fund_Structure_Type,
  ...
  FROM {silver_prefix}fundoperations_by_investor_type_monthly
),
totals AS (
  SELECT
    Fund,
...
ORDER BY d.Fund, d.Year_Month, d.Transaction_Currency, d.Investor_Type
'''