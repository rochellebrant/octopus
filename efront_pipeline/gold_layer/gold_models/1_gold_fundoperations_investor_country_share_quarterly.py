...
gold_fundoperations_investor_country_share_quarterly_sql_code = '''
WITH detail AS (
  SELECT
    Fund,
    Fund_Structure_Type,
  ...
  FROM {silver_prefix}fundoperations_by_investor_country_quarterly
),
totals AS (
  SELECT
    Fund,
...
ORDER BY d.Fund, d.Year_Quarter, d.Transaction_Currency, d.Investor_Country
'''