...
"aum_bridge":
      {
            ...
            "non_null_columns":["Report_Date", "Previous_AUM", "Asset_Capital_Injections", "Asset_NAV_Change", "Asset_Committed_Equity",
                                "Asset_Debt_Movements", "Asset_Disposals", "Fund_Level_Adj", "Current_AUM", "Refresh_Timestamp"],
