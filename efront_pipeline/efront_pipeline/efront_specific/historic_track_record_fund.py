...
# MAGIC %md
# MAGIC https://octoenergy.sharepoint.com/:x:/r/sites/Or-Data/Shared%20Documents/Data/datalake_resources/eFront/Historic_TR_DL.xlsx?d=w1e8fed428d4745d88a01f7ce412f1136&csf=1&web=1&e=NxyIDu
...
from pyspark.sql.functions import current_timestamp, col, to_timestamp, trim, date_format
...
# DBTITLE 1,Cell 1
table = "track_record_fund_historics"

path = "/Volumes/oegen_data_prod_source/src_blackrock_efront_xio/landing_investments_efront/Historic_TR_Fund_DL.csv"

cols_to_select = ["ANNUALISED_YIELD", "ANNUAL_YIELD", "DPI", "FUND_SHORT", "MOIC", "NET_CAGR", "NET_TOTAL_RETURN", "REPORTING_DATE", "UNREALISED_GROSS_IRR", "UNREALISED_NET_IRR", "WEIGHTED_YIELD_UNITS"]
