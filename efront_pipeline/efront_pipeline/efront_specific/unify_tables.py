...
if IS_DATABRICKS:
    ...
    dbutils.widgets.text("PARAMETER_MODULE", "union_parameters")
    param_module_name = dbutils.widgets.get("PARAMETER_MODULE")
else:
...
from utils import apply_env_prefixes, unify_tables
