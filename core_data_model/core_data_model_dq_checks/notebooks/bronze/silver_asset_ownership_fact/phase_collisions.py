...
silver_asset_ownership_fact = spark.table(f"{source_fqtn}")

asset_col = "asset_id" 
date_col = "event_date"
type_col = "ownership_milestone_type_id"
phase_col = "ownership_phase_id"
milestone_col = "ownership_milestone_id"

# COMMAND ----------

# Group by the collision keys: Asset + Date + Type
issues_df = (
    silver_asset_ownership_fact
