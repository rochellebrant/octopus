...
with patch("databricks.sdk.WorkspaceClient"), patch(
...
def runtime_config():
    return {
        "source_db": "prod_catalog.source_schema",
        "dq_db": "prod_catalog.dq_schema",
    }


@pytest.fixture
def runner(mock_spark, runtime_config):
    with patch("libraries.dq_framework.engine.runner.WorkspaceClient"), patch(
        "libraries.dq_framework.engine.runner.DQEngine"
